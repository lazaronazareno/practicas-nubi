...
import logos from '../../assets/images/logos.js';
...
class Recargas extends React.Component {
  ...
  return(
    <div className={styles.container}>
      ...
      <h2 className={styles.text}>Con Nubi agregá dinero a tu cuneta PayPal desde tu banco y comprá en todo el mundo sin tarjeta de crédito. ¡Si no tenés cuenta PayPal creátela desde Nubi en unos simple pasos!</h2>
